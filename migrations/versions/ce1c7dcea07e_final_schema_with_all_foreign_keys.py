"""Final schema with all foreign keys

Revision ID: ce1c7dcea07e
Revises: 
Create Date: 2025-07-27 17:52:12.612013
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['client_id', 'user_id'], ['neondb.user.client_id', 'neondb.user.id'], ),
    sa.ForeignKeyConstraint(['client_id'], ['neondb.clients.id'], ),
    sa.PrimaryKeyConstraint('id'),
    schema='neondb'
    )
